...
def get_mbti_info(mbti_type):
    mbti_descriptions = {
        "ENTJ": {
            "ผู้บัญชาการ": "ผู้ที่มีความเป็นผู้นำสูง วิเคาะห์บนหลักของเหตุและผล มีความมั่นใจ และมีอิทธิพลต่อคนรอบข้า",
            "อาชีพ": ["นักการเมือง ทนายความ อัยการ ผู้พิพากษา เป็นต้น"]
        },
        "ENTP": {
            "นักโต้วาที": "ผู้ที่มีความคิดสร้างสรรค์ ฉลาด และมีไหวพริบที่ดี ชื่นชอบการถกเถียงและวิจารณ์ประเด็นต่าง ๆ บนพื้นฐานของเหตุและผล",
            "ผู้เป็นตัวเอก": ["ผู้ที่มีเสน่ห์ เข้าใจผู้อื่น มักใส่ใจความรู้สึกผู้อื่นมากเกินไป ชอบให้ความช่วยเหลือคนรอบข้าง"]
        },
        {
        "ENFJ": {
        "ผู้เป็นตัวเอก": "ผู้ที่มีเสน่ห์ เข้าใจผู้อื่น มักใส่ใจความรู้สึกผู้อื่นมากเกินไป ชอบให้ความช่วยเหลือคนรอบข้าง",
        "อาชีพ": [
            "นักโฆษณา", "นักแสดงต่าง ๆ", "นักประชาสัมพันธ์", "นางแบบ - นายแบบ",
            "นักจัดรายการวิทยุโทรทัศน์", "ผู้ออกแบบเครื่องแต่งกาย", "นักวิจารณ์",
            "ผู้ออกแบบเครื่องเรียน", "มัณฑนากร", "สถาปนิก"]
        },
        "ENFP": {
        "นักรณรงค์": "ผู้ที่มีความคิดสร้างสรรค์ ชอบความท้าทาย มีมนุษย์สัมพันธ์ที่ดี มักจะมีเพื่อนเยอะเพราะเข้ากับได้กับทุกคน",
        "อาชีพ": ["นักประมง", "นักเดินป่า", "พนักงานป่าไม้", "นักกีฬา", "นักเดินเรือ", "นักประดาน้ำ"]
        },
        "ESTJ": {
        "ผู้บริหาร": "ผู้ที่มีความสามารถในการตัดสินใจอย่างมีเหตุผล เป็นกลาง ชัดเจน ลงมือปฏิบัติบนพื้นฐานของความเป็นจริงที่เป็นไปได้",
        "อาชีพ": ["นายหน้าซื้อขาย", "ที่ปรึกษาทางธุรกิจ"]
        },
        "ESTP": {
        "ผู้ประกอบการ": "ผู้ที่มีความกระฉับกระเฉง ช่างสังเกต ชอบแข่งขัน มองเห็นรายละเอียดของสิ่งต่าง ๆ และวิเคราะห์สถานการณ์ได้เป็นอย่างดี",
        "อาชีพ": ["นักธุรกิจ", "นักการตลาด", "นักบริหาร", "ผู้จัดการ"]
        },
        "ESFJ": {
        "ผู้ให้คำปรึกษา": "ผู้ที่มีความเห็นใจผู้อื่น มักชอบอยู่กับผู้คน เป็นที่รักของคนหมู่มาก เป็นมิตร มักได้รับความไว้วางใจจากผู้อื่น",
        "อาชีพ": ["นักแนะแนว", "ผู้ให้คำปรึกษา"]
        },
        "ESFP": {
        "ผู้มอบความบันเทิง": "ผู้ที่ชอบความสนุกสนาน เป็นมิตร กระตือรือร้น มีทักษะทางสังคมที่ดี เข้าสังคมเก่ง",
        "อาชีพ": [
            "นักประดิษฐ์", "ช่างภาพ", "ช่างพิมพ์", "นักออกแบบ", "นักประพันธ์", "นักพากย์",
            "นักเต้นรำ", "นักเขียนการ์ตูน", "ครูสอนศิลปะ", "วาทยกร"
        ]
        },
        "INTJ": {
        "นักกลยุทธ์": "ผู้มีแผนการสำหรับทุกอย่าง เป็นนักคิด ช่างสังเกต ช่างจินตนาการ และมองการไกล กระหายความรู้ใหม่ ๆ",
        "อาชีพ": ["นักสถิติ", "เจ้าหน้าที่วิเคราะห์การเงิน"]
        },
        "INTP": {
        "นักตรรกะ": "ผู้ที่มุ่งเน้นเกี่ยวกับแนวคิด ทฤษฎี หลักการที่อยู่บนความเป็นจริง ชอบสร้างสรรค์สิ่งใหม่ ๆ อย่างมีแบบแผน",
        "อาชีพ": [
            "นักฟิสิกส์", "นักพยาธิวิทยา", "นักวิทยาศาสตร์", "นักสถิติ", "นักชีววิทยา",
            "นักจุลชีววิทยา", "นักเคมี", "นักวางแผน", "นักวิชาการ"
        ]
        },
        "INFJ": {
        "ผู้สนับสนุน": "ผู้ที่มีความเป็นตนเองสูง ดูเป็นคนเงียบ ๆ แต่เร็วต่อความรู้สึก มีความเห็นอกเห็นใจและเข้ากับผู้อื่นได้ง่ายไม่มีชื่อ",
        "อาชีพ": ["ครู - อาจารย์", "นักวิชาการ"]
        },
        "INFP": {
        "ผู้ไกล่เกลี่ย": "ผู้ที่ชอบช่วยเหลือผู้อื่น มีความซื่อสัตย์ มองสิ่งต่าง ๆ ในมุมมองที่เป็นบวก ใจกว้าง ยืดหยุ่น เคารพและรับฟังทุกความคิดเห็น",
        "อาชีพ": ["ผู้จัดการ", "บรรณารักษ์", "นักโภชนาการ", "ล่าม", "มัคคุเทศน์", "นักเทศน์"]
        },
        "ISTJ": {
        "นักคำนวณ": "ผู้ที่วิเคราะห์สิ่งต่าง ๆ ตามความเป็นจริง คำนึงถึงสิ่งที่เป็นไปได้หรือข้อเท็จจริงมากกว่าการจินตนาการ",
        "อาชีพ": [
            "สมุห์บัญชี", "นักบัญชี", "เลขานุการ", "เจ้าหน้าที่ธนาคาร", "ตรวจสอบบัญชี",
            "เจ้าหน้าที่สารบรรณ", "ผู้ช่วยบรรณารักษ์", "เจ้าหน้าที่สรรพากร", "เจ้าหน้าที่คอมพิวเตอร์"
        ]
        },
        "ISTP": {
        "ผู้เชี่ยวชาญ": "ผู้ที่พัฒนาและทดลองสิ่งต่าง ๆ บนพื้นฐานของความเป็นจริง ชอบทำมากกว่าพูด แต่บางครั้งก็ทำอะไรปุบปับจนคาดเดาอารมณ์ได้ยาก",
        "อาชีพ": [
            "ช่างเทคนิค", "ช่างฝีมือ", "ช่างซ่อม", "ช่างฟิต", "ช่างสำรวจ", "ช่างไฟฟ้า",
            "ช่างยนต์", "ช่างตัดเสื้อ", "ช่างก่อสร้าง", "ช่างเครื่อง", "ช่างประปา"
        ]
        },
        "ISFJ": {
        "ผู้พิทักษ์": "ผู้ที่คำนึงถึงคนอื่นเสมอ รักเพื่อนพ้อง ทุ่มเทและซื่อสัตย์ให้กับคนที่ตนเองไว้ใจ มักมองหาทางออกที่ไม่ก่อให้เกิดความขัดแย้ง",
        "อาชีพ": [
            "พยาบาล", "นักสังคมสงเคราะห์", "นักสังคมวิทยา", "เจ้าหน้าที่งานบุคคล",
            "นักฝึกอบรม", "นักพัฒนากร", "ทูต"
        ]
        },
        "ISFP": {
        "นักผจญภัย": "ผู้ที่รักในอิสระ ชอบความสันโดษแต่ก็เข้ากับคนอื่นได้ง่าย ปรับตัวเก่ง อ่อนไหวต่อความรู้สึก",
        "อาชีพ": [
            "ผู้กำกับการแสดง", "ผู้สื่อข่าวเต้นรำ", "นักดนตรี", "นักโฆษณา", "นักแสดงต่าง ๆ",
            "นักประชาสัมพันธ์", "นางแบบ - นายแบบ", "นักจัดรายการวิทยุโทรทัศน์", "นักวิจารณ์", "จิตรกร"
        ]
    }
